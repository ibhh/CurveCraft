	...
	private void createLanguageConfig()
	{
		for(int i = 0; i < 2; i++)
		{
			...
			if(i == 0)
			{
				...
				this.language_config.addDefault("create.notfinished.start2", "Und eine Position für die Lobby /cc setlobby und eine Position fuer ausgeschieden Spieler /cc setend and eine exit Position mit /cc setexit. Schliesse den Prozess mit /cc finish ab");
				...
				this.language_config.addDefault("commands.forcestart.usage", "/cc forcestart ARENANAME");
				...
				this.language_config.addDefault("commands.list.name", "list");
				this.language_config.addDefault("commands.list.permission", "CurveCraft.play");
				this.language_config.addDefault("commands.list.description", "Listet alle geladenen Arenen auf.");
				this.language_config.addDefault("commands.list.usage", "/cc list");
				...
				this.language_config.addDefault("commands.enable.description", "Aktiviert eine Arena");
				...
				this.language_config.addDefault("commands.disable.description", "Deaktiviert eine Arena.");
				this.language_config.addDefault("commands.disable.usage", "/cc disable [ARENA]");

				this.language_config.addDefault("commands.deletearena.name", "deletearena");
				this.language_config.addDefault("commands.deletearena.permission", "CurveCraft.deletearena");
				this.language_config.addDefault("commands.deletearena.description", "Loescht die Arena fuer immer");
				this.language_config.addDefault("commands.deletearena.usage", "/cc deletearena [ARENA]");
			...
			else
			{
				...
				this.language_config.addDefault("create.notfinished.start2", "And a position for the lobby /cc setlobby and a position for eleminated player /cc setend and an exit position /cc setexit. Finish the process with /cc finish");
				...
				this.language_config.addDefault("commands.list.name", "list");
				this.language_config.addDefault("commands.list.permission", "CurveCraft.play");
				this.language_config.addDefault("commands.list.description", "Lists all loaded arenas");
				this.language_config.addDefault("commands.list.usage", "/cc list");
				...
				this.language_config.addDefault("commands.deletearena.name", "deletearena");
				this.language_config.addDefault("commands.deletearena.permission", "CurveCraft.deletearena");
				this.language_config.addDefault("commands.deletearena.description", "Deletes the arena permanently.");
				this.language_config.addDefault("commands.deletearena.usage", "/cc deletearena [ARENA]");

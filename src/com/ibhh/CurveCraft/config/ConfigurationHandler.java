    ...
    private void createLanguageConfig() {
        for (int i = 0; i < 2; i++) {
            ...
            if (i == 0) {
                ...
                this.language_config.addDefault("privacy.notification.2", "\"/cf allowtracking\" um den Plugin dies zu erlauben");
                this.language_config.addDefault("privacy.notification.3", "\"/cf denytracking\" um deine Daten zu anonymisieren");
                ...
                this.language_config.addDefault("create.notfinished.start", "Du musst einen Namen und zwei Ecken fuer die Arena setzen! Benutze /cf setname NAME und /cf setcorner1 /cf setcorner2 um deine aktuelle Position als Ecke zu setzen!");
                this.language_config.addDefault("create.notfinished.start2", "Und eine Position für die Lobby /cf setlobby und eine Position fuer ausgeschieden Spieler /cf setend and eine exit Position mit /cf setexit");
                ...
                this.language_config.addDefault("create.already", "Es wird bereits eine Arena erstellt. /cf cancel um Abzubrechen");
                this.language_config.addDefault("create.noarena", "Starte erst eine Arena! /cf create");
                ...
                this.language_config.addDefault("create.notfinished.nameexist", "Eine Arena mit diesem Namen besteht bereits, setzte bitte einen Neuen (/cf setname)");
                this.language_config.addDefault("create.notfinished.noname", "Du musst einen Namen für die Arena definieren! /cf setname NAME");
                this.language_config.addDefault("create.notfinished.nocorner", "Du musst die zwei gegenueberliegende Ecken für die Arena definieren! /cf setcorner1 NAME und /cf setcorner2 NAME");
                this.language_config.addDefault("create.notfinished.wrongY", "Beide Ecken muessen die gleiche Y-Koordinate haben.");
                this.language_config.addDefault("create.notfinished.lobbyloc", "Es muss eine Lobby-Position mit /cf setlobby gestetzt werden.");
                this.language_config.addDefault("create.notfinished.endloc", "Es muss eine End-Position mit /cf setend gesetzt werden");
                this.language_config.addDefault("create.notfinished.exitloc", "Es muss eine Exit-Position mit /cf setexit gesetzt werden");
                ...
                this.language_config.addDefault("commands.setexit.usage", "/cf setexit");
                ...
                this.language_config.addDefault("commands.setlobby.usage", "/cf setlobby");
                ...
                this.language_config.addDefault("commands.setend.usage", "/cf setend");

                this.language_config.addDefault("create.cancel.message", "Du hast die Erstellung abgebrochen!");
                this.language_config.addDefault("create.already", "Es wird schon eine Arena erstellt /cf cancel um abzubrechen");
                this.language_config.addDefault("create.noarena", "Keine Arena ausgewaehlt. Starte mit die Erstellung mit /cf create");
                ...
                this.language_config.addDefault("lobby.join.message3", "Das Spiel kann ab %d Spielern gestartet werden, wenn alle /cf start eingeben.");
                ...
                this.language_config.addDefault("commands.lobby.usage", "/cf lobby");
                ...
                this.language_config.addDefault("commands.exit.usage", "/cf exit");
                ...
                this.language_config.addDefault("commands.join.usage", "/cf join ARENA");
                ...
                this.language_config.addDefault("commands.start.usage", "/cf start");
                ...
                this.language_config.addDefault("commands.help.usage", "/cf help");
                ...
                this.language_config.addDefault("commands.create.usage", "/cf create");
                ...
                this.language_config.addDefault("commands.finish.usage", "/cf finish");
                ...
                this.language_config.addDefault("commands.cancel.usage", "/cf cancel");
                ...
                this.language_config.addDefault("commands.setname.usage", "/cf setname");
                ...
                this.language_config.addDefault("commands.setcorner1.usage", "/cf setcorner1");
                ...
                this.language_config.addDefault("commands.setcorner2.usage", "/cf setcorner2");
                ...
                this.language_config.addDefault("commands.version.usage", "/cf version");
                ...
                this.language_config.addDefault("commands.denytracking.usage", "/cf denytracking");
                ...
                this.language_config.addDefault("commands.allowtracking.usage", "/cf allowtracking");
            } else {
                ...
                this.language_config.addDefault("privacy.notification.2", "\"/cf allowtracking\" to allow the plugin to save your data");
                this.language_config.addDefault("privacy.notification.3", "\"/cf denytracking\" to anonymise your data");
                ...
                this.language_config.addDefault("create.notfinished.start", "You must set a name and two corners for the arena! Use /cf setname NAME and /cf setcorner1 /cf setcorner2 to set your position as corner!");
                this.language_config.addDefault("create.notfinished.start2", "And a position for the lobby /cf setlobby and a position for eleminated player /cf setend and an exit position /cf setexit");
                ...
                this.language_config.addDefault("create.notfinished.exit", "Exit position set.");
                this.language_config.addDefault("create.notfinished.nameexist", "Arena already exit with this name, choose another one (/cf setname)");
                this.language_config.addDefault("create.notfinished.noname", "You must set a name for the arena! /cf setname NAME");
                this.language_config.addDefault("create.notfinished.nocorner", "You must define two corners of the arena! /cf setcorner1 NAME und /cf setcorner2 NAME");
                this.language_config.addDefault("create.notfinished.wrongY", "Both corners must have the same Y-Coordinate");

                this.language_config.addDefault("create.notfinished.lobbyloc", "You must set a lobby position (/cf setlobby)");
                this.language_config.addDefault("create.notfinished.endloc", "You must set an end position(/cf setend)");
                this.language_config.addDefault("create.notfinished.exitloc", "You must set an exit position(/cf setexit)");
                ...
                this.language_config.addDefault("create.already", "An arena is in creation /cf cancel to cancel");
                this.language_config.addDefault("create.noarena", "Start a creation prozess first! /cf create");
                ...
                this.language_config.addDefault("lobby.join.message3", "The game can start if there are %d players and all typed /cf start to start the game.");
